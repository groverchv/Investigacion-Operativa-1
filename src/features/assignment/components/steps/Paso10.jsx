 ...
 * COMPONENTE: Paso10
 * ============================================
 * Aplica iterativamente la logica del metodo hungaro
 * hasta cubrir todos los ceros con lineas minimas.
 * 
 * @param {Array} matriz - Matriz de entrada
 * @param {Array} nombresFilas - Informacion de grupos
 * @param {Array} nombresColumnas - Informacion de horarios
 * @param {Function} onResolved - Callback con resultado final
 */
...
// Estilos para celdas tachadas y ceros
const styles = `
        ...
        return (
          ...
          >
            ...
            <div style={{
              ...
              <Tag color="blue">Filas cubiertas: {iter.totalFilas}</Tag>
              <Tag color="cyan">Columnas cubiertas: {iter.totalColumnas}</Tag>
              <Tag color="purple">Total lineas: {iter.totalFilas + iter.totalColumnas}</Tag>
              {iter.cumple ? (
